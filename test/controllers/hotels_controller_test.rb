...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference("Hotel.count") do
      post hotels_url, params: { hotel: { hotel_address: @hotel.hotel_address, hotel_name: @hotel.hotel_name } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { hotel_address: @hotel.hotel_address, hotel_name: @hotel.hotel_name } }
